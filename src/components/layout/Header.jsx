  ...
  return (
    <header className="px-6 py-6 bg-[#F9F9F9] flex justify-between items-center sticky top-0 z-10 border-b border-gray-100">
      ...
      <div className="flex gap-2">
        <button className="relative p-2 bg-white rounded-xl shadow-sm border border-gray-50">
          <Bell size={18} className="text-gray-600" />
          <span className="absolute top-1 right-1 w-2 h-2 bg-red-500 rounded-full"></span>
        </button>
        <button className="p-2 bg-white rounded-xl shadow-sm border border-gray-50 text-gray-600">
          <User size={18} />
        </button>
      </div>
    </header>
